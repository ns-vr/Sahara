...
def get_evacuation_advice(city: str, disaster_type: str, urgency: str) -> str:
    """
    Uses Claude to generate specific evacuation/safety advice based on context.
    """
    prompt = f"""You are SAHARA's Relief Coordinator. Give concise evacuation and safety advice.

City: {city}, India
Disaster: {disaster_type.upper()}
Medical Urgency: {urgency}

Give 4 specific, actionable evacuation/safety steps for RIGHT NOW.
Be extremely brief — one line each. Start each with an emoji.
End with one sentence about what NOT to do."""
    ...
    try:
        ...
        # Fallback advice
        return {
            "flood":    "🏃 Move to higher ground immediately.\n📵 Avoid walking in floodwater.\n🔦 Keep torch and phone charged.\n📞 Call 112 if trapped.\n❌ Do NOT drive through flooded roads.",
            "heatwave": "🏠 Stay indoors during 11am-4pm.\n💧 Drink water every 20 minutes.\n🧊 Apply cold compress to neck/wrists.\n📞 Call 108 if someone collapses.\n❌ Do NOT exercise outdoors.",
            "fire":     "🚪 Evacuate immediately via stairs not lift.\n👃 Cover mouth with wet cloth.\n🔽 Stay low — smoke rises.\n📞 Call 101 (Fire) immediately.\n❌ Do NOT go back for belongings.",
            "storm":    "🏠 Stay indoors away from windows.\n⚡ Unplug all electronics.\n🌊 Move away from rivers/coast.\n📞 Call 112 for emergencies.\n❌ Do NOT shelter under trees.",
        }.get(disaster_type, "📞 Call 112 for emergency assistance.")
